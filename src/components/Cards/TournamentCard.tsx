            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <div className='flex items-center mr-2'>
                <Link href={`/tournaments/${id}`}>
                  <span className={`${roboto.className} block px-3 py-2 border text-gray-900 dark:text-gray-200 dark:border-gray-400 border-black tracking-wide hover:border-transparent dark:hover:bg-gray-700 dark:hover:border-transparent hover:bg-[#FFD449]/40 transition-all duration-500`}>
                    INFO
                  </span>
                </Link>
              </div>
                ...
                <Link href={`/tournaments/signups/${id}`}>
                  <span className={`${roboto.className} hidden sm:block px-3 py-2 border text-gray-900 dark:text-gray-200 dark:border-gray-400 border-black tracking-wide hover:border-transparent dark:hover:bg-gray-700 dark:hover:border-transparent hover:bg-[#FFD449]/40 transition-all duration-500`}>
                    SIGNUPS
                  </span>
                </Link>
                :
