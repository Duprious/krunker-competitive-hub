  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 mb-6 w-full group">
            <input type="datetime-local" id="startDate" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("dates.startDate")} />
          ...
          <div className="relative z-0 mb-6 w-full group">
            <input type="datetime-local" id="endDate" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("dates.endDate")} />
