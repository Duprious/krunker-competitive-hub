    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="relative z-0 mb-6 w-full group">
            <input type="text" id="name" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("name")} />
        ...
        <div className="relative z-0 mb-6 w-full group">
            <input type="text" id="description" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("description")} />
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 mb-6 w-full group">
              <input type="text" id="hostName" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("hostName")} />
          ...
          <div className="relative z-0 mb-6 w-full group">
              <input type="number" id="maxTeams" min={0} max={64} className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("maxTeams", { setValueAs: (v) => v === "" ? undefined : parseInt(v, 10) })} />
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 mb-6 w-full group">
            <input type="datetime-local" id="startDate" className="dark:calendar-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("dates.startDate")} />
          ...
          <div className="relative z-0 mb-6 w-full group">
            <input type="datetime-local" id="endDate" className="dark:calendar-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none dark:text-white text-black border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " {...register("dates.endDate")} />
          ...
          <div className="relative z-0 mb-6 w-full group">
            ...
            <select id="type" className="border text-sm rounded-lg block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:text-white text-black focus:ring-blue-500 focus:border-blue-500" {...register("type")} >
              <option>4v4</option>
              <option>3v3</option>
              <option>2v2</option>
            </select>
          ...
          <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-400">Select Tournament Server</label>
            <select id="countries" className="border text-sm rounded-lg block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:text-white text-black focus:ring-blue-500 focus:border-blue-500" {...register("region")} >
          ...
          <label htmlFor="organization" className="block mb-2 text-sm font-medium text-gray-400">Select Organization</label>
            <select id="organization" className="border text-sm rounded-lg block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 placeholder-gray-400 dark:text-white text-black focus:ring-blue-500 focus:border-blue-500" {...register("organization")} >
        ...
        <button type="submit" className="dark:text-white text-black focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Submit</button>
      </form>
      <Toaster />
    </>
  )
