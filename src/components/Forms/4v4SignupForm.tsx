                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='grid grid-cols-2 space-x-8'>
                          <div>
                            ...
                            <label htmlFor="playerFourDiscord" className="block mb-2 text-sm font-medium mt-4 text-white">Discord Player 4</label>
                            <input type="text" id="playerFourDiscord" className="border sm:text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder='flipbait#0001' {...register("discordPlayerFour")} />
                          ...
                          <div>
                            ...
                            <label htmlFor="playerFourIGN" className="block mb-2 text-sm font-medium mt-4 text-white">IGN Player 4</label>
                            <input type="text" id="playerFourIGN" className="border sm:text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder='flipbait' {...register("ignPlayerFour")} />
