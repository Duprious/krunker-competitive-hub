          ...
          <div className='flex flex-col pt-6'>
            ...
            <div className='pt-8'>
              <Link href="/kpc/signup">
                <button className="text-white mt-4 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">
                  Sign Up Here
                </button>
              </Link>
            </div>
