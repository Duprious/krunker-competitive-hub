            ...
            <div className="flex flex-col justify-between gap-8 md:flex-row">
              ...
              <form className='text-center mx-auto md:mr-8' onSubmit={(e) => e.preventDefault()}>   
                ...
                <div className="relative">
                    ...
                    <input autoComplete='off' onChange={(e) => handleSearch(e)} type="search" id="default-search" className="block p-4 pl-10 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Search Players" required />
                </div>
              </form>
            </div>
            <hr className="mt-10" />
